...
hui.define('hui_checklabel', ['hui@0.0.1'], function () {
    ...
    hui.CheckLabel.prototype = {
        ...
        saveLabel: function () {
            ...
            if (value === '' && (Number(label_id) > 0 || String(me.getPresetValue()).indexOf('-') === 0)) {
                if (String(me.getPresetValue()).indexOf('-') !== 0) {
                ...
                if (String(me.getPresetValue()).indexOf('-') === 0 || window.confirm('Are you sure change label?')) {
 ...
 * @param {Object} options 控件初始化参数.
 */
hui.define('hui_table', ['hui@0.0.1', 'hui_control@0.0.1'], function () {
 ...
 * @example
 ...
 url_save:'/savelabelUrl',url_remove:'/removelabelUrl',url_list:'/labellist',auto123:'true'"></div>
 */
hui.define('hui_draggable', ['hui@0.0.1'], function () {
